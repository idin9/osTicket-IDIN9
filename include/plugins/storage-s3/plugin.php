...
return array(
    ...
    'name' =>           /* trans */ 'Attachments hosted in S3-compatible storage',
    'author' =>         'Jared Hancock, Kevin Thorne, IDIN9',
    'description' =>    /* trans */ 'Enables storing attachments in Amazon S3, Wasabi, Google Cloud Storage, DigitalOcean Spaces, Backblaze B2, Cloudflare R2, MinIO, or custom S3-compatible storage',
